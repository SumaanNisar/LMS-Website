    ...
    <>
      <div className="relative flex md:flex-row flex-col-reverse gap-10 items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
              ...
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  <div className="flex items-center justify-between px-4 py-3 cursor-pointer select-none">
                    ...
                    <p className="text-sm ms:text-default">
          ...
          <div className="p-20 text-sm md:text-default">
        ...
        <div className="max-w-[424px] shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] z-10 rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="pt-6">
              <p className="md:text-xl text-lg font-meduim text-gray-800">
                What's is in the course?
              </p>
